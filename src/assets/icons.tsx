...
export function AddDiscountIcon(props: any) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className='icon icon-tabler icons-tabler-outline icon-tabler-discount'
    >
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
      <path d='M9 15l6 -6' />
...
export function AddCategoryIcon(props: any) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
